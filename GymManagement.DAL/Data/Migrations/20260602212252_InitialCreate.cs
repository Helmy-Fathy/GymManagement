        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategryName = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PhoneCheck", "PhoneNumber like '010%' or PhoneNumber like '011%' or PhoneNumber like '015%' or PhoneNumber like '012%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PhoneCheck1", "PhoneNumber like '010%' or PhoneNumber like '011%' or PhoneNumber like '015%' or PhoneNumber like '012%'");
                });
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CategryName", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, "Cardio", null },
                    { 2, "Strength", null },
