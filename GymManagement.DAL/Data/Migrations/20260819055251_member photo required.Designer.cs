...
namespace GymManagement.DAL.Data.Migrations
{
    ...
    [Migration("20260819055251_member photo required")]
    partial class memberphotorequired
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("Members", t =>
                        {
                            ...
                            t.HasCheckConstraint("PhoneCheck", "PhoneNumber like '010%' or PhoneNumber like '011%' or PhoneNumber like '015%' or PhoneNumber like '012%'");
                        });
                });
